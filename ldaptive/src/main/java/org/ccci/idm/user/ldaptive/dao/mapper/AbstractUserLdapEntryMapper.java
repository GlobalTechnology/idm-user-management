...
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_CHANGEEMAILKEY;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_CN;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_DOMAINSVISITED;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_EMAIL;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_FACEBOOKID;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_FACEBOOKIDSTRENGTH;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_FIRSTNAME;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_GROUPS;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_GUID;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_LASTNAME;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_OBJECTCLASS;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_PASSWORD;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_PROPOSEDEMAIL;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_RELAY_GUID;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_RESETPASSWORDKEY;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_SIGNUPKEY;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_THEKEY_GUID;
import static org.ccci.idm.user.dao.Constants.LDAP_ATTR_USERID;
import static org.ccci.idm.user.dao.Constants.LDAP_DEACTIVATED_PREFIX;
import static org.ccci.idm.user.dao.Constants.LDAP_FLAG_ALLOWPASSWORDCHANGE;
import static org.ccci.idm.user.dao.Constants.LDAP_FLAG_EMAILVERIFIED;
import static org.ccci.idm.user.dao.Constants.LDAP_FLAG_LOCKED;
import static org.ccci.idm.user.dao.Constants.LDAP_FLAG_LOGINDISABLED;
import static org.ccci.idm.user.dao.Constants.LDAP_FLAG_STALEPASSWORD;
import static org.ccci.idm.user.dao.Constants.LDAP_OBJECTCLASSES_KEYUSER;
